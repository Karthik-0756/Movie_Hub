...
const SelectedMovie = () => {
    ...
    return (
        <div className="bg-black text-white   ">
            ...
            <div className="mx-40 pt-30  ">

                <div className="flex  ">
                    <div>
                        <img className="h-150 rounded-2xl mb-30" src={bgImage} alt="" />
                    ...
                    <div className="pl-30 mt-5">
                        ...
                        <div className="flex mt-15">
                            {movie.genres?.map((genres) => (
                                <p className="w-50 h-10 rounded bg-gray-900 p-2 mr-5 text-white text-center" key={genres.id}>{genres.name}</p>
                            ))}
                        </div>
                        <div className="flex">
                        ...
                        <p className="w-80 mt-4 font-light">{movie.overview}</p>
                ...
                {viewTrailer && (
                    <>
                        ...
                        <iframe className="w-300 h-150 mt-10  pb-30" src={`https://www.youtube.com/embed/${videoKey}`} frameborder="0"></iframe>
